...
out <-  hydroxy$data |> dplyr::arrange(value) |> dplyr::select(visitId, subjectId, value) |> dplyr::mutate(id = match(subjectId, sample(unique(subjectId)))) |>
...
out <-  acetoin$data |> dplyr::arrange(value) |> dplyr::select(visitId, subjectId, value) |> dplyr::mutate(id = match(subjectId, sample(unique(subjectId)))) |>
  dplyr::arrange(id) |> dplyr::select(-subjectId)
...
out <-  thymine$data |> dplyr::arrange(value)|> dplyr::select(visitId, subjectId, value) |> dplyr::mutate(id = match(subjectId, sample(unique(subjectId)))) |>
  dplyr::arrange(id) |> dplyr::select(-subjectId)
...
```{r sourcedata.lysine}
out <-  lysine$data |> dplyr::arrange(value)|> dplyr::select(visitId, subjectId, value) |> dplyr::mutate(id = match(subjectId, sample(unique(subjectId)))) |>
  dplyr::arrange(id) |> dplyr::select(-subjectId)
...
```{r sourcedata.lact}
out <-  lact$data |> dplyr::arrange(value)|> dplyr::select(visitId, subjectId, value) |> dplyr::mutate(id = match(subjectId, sample(unique(subjectId)))) |>
  dplyr::arrange(id) |> dplyr::select(-subjectId)
...
```{r sourcedata.chol}
out <-  chol$data |> dplyr::select(visitId, subjectId, value) |> dplyr::mutate(id = match(subjectId, sample(unique(subjectId)))) |>
  dplyr::arrange(id) |> dplyr::select(-subjectId)
...
```{r sourcedata.trim}
out <-  trim$data |> dplyr::select(visitId, compliance, subjectId, value) |> dplyr::mutate(id = match(subjectId, sample(unique(subjectId)))) |>
  dplyr::arrange(id) |> dplyr::select(-subjectId)
...
```{r sourcedata.beta}
out <-  beta$data |> dplyr::select(visitId, subjectId, value) |> dplyr::mutate(id = match(subjectId, sample(unique(subjectId)))) |>
  dplyr::arrange(id) |> dplyr::select(-subjectId)
