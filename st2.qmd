...
Supplementary Table 2 is the output of [Wilcoxon tests](helper-wilcoxon-tests.qmd) run on all individuals who finished the study (intention to treat); paired.
